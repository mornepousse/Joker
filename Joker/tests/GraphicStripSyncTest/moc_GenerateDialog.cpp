...
#include <memory>
#include "../GraphicStripTest/GenerateDialog.h"
...
QT_MOC_LITERAL(3, 30, 8) // "onAccept"

    },
    "GenerateDialog\0onTextChanged\0\0onAccept"
};
...
void GenerateDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GenerateDialog *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject GenerateDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_GenerateDialog.data,
    qt_meta_data_GenerateDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
