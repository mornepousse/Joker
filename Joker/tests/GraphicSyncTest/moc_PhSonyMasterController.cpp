...
void PhSonyMasterController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PhSonyMasterController *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (PhSonyMasterController::*)(unsigned char , unsigned char );
        ...
        {
            using _t = void (PhSonyMasterController::*)(unsigned char * , int , int );
...
QT_INIT_METAOBJECT const QMetaObject PhSonyMasterController::staticMetaObject = { {
    QMetaObject::SuperData::link<PhSonyController::staticMetaObject>(),
    qt_meta_stringdata_PhSonyMasterController.data,
    qt_meta_data_PhSonyMasterController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
